  ...
  return (
    <footer className="mt-24" style={{ background: "var(--color-ink-900)" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul
            ...
            style={{ color: "var(--color-ink-400)" }}
          >
            <li>support@Online Hospital Appointmentplus.com</li>
      ...
      <div className="border-t border-white/10">
        <div
          className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row justify-between items-center gap-3 text-xs"
          style={{ color: "var(--color-ink-400)" }}
        >
          <p>© {year} Online Hospital Appointment+. All rights reserved.</p>
